...
function scripts.plugins_installer:install_from_url(url)
    ...
    self.plugin_download_handler = scripts.event_register:force_register_event_handler("download_plugin", "sysDownloadDone", function(_, filename) self:handle_download(_, filename, plugin_name, branch) end)
...
function scripts.plugins_installer:handle_download(_, filename, plugin_name, branch)
    ...
    scripts.event_register:register_event_handler("sysUnzipDone", function(event, ...) self:handle_unzip(event, plugin_name, branch,  ...) end, true)
    scripts.event_register:register_event_handler("sysUnzipError", function(event, ...) self:handle_unzip(event, plugin_name, branch,  ...) end, true)
