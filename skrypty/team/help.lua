function ateam:print_help()
    ...
    cecho("|                  --------------------------------------                        |\n")
    cecho("|                                                                                |\n")
    cecho("| <light_slate_blue>/q [id]<grey> - doda wroga o id [id] do kolejki ataku. Po zabiciu,                   |\n")
    cecho("| kolejna postac z kolejki zostanie zbindowana pod bindem <light_slate_blue>'/nn'<grey>                  |\n")
    cecho("|                                                                                |\n")
