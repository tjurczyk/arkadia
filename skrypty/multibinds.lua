...
function scripts.multibinds:clear_location(room_id, index)
    db:delete(self.db.multibinds, { db:eq(self.db.multibinds.room_id, room_id), db:eq(self.db.multibinds.index, index) })
end
