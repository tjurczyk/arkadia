...
function trigger_func_skrypty_ui_gags_ciosy_waski_kunsztowny_sihill()
    ...
    elseif dmg == "kontrujesz" or dmg == "tnac" then value = 3
    elseif dmg == "gleboko" or dmg == "raniac" or dmg == "wbija" then value = 4
    elseif dmg == "ogromne" then value = 5
    elseif dmg == "smiertelne" or dmg == "bryzg" then
...
function trigger_func_skrypty_ui_gags_ciosy_gorejacy_dlugi_talwar()
    ...
    -- znacznie: kolor obrazen potwierdza pasmo wysokie (4/4), ale ono obejmuje stopnie 3-5; sama czworka wynika z pozycji w rozkladzie czestotliwosci
