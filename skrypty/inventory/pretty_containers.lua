...
local wear = { "futro", "kubraczek", "koszula", "sukni", "plaszcz", "peleryn", "tog", "szat", "bloniaste skrzydl", "chust", "pas", "gemm", "obroz", "szat", "kolnierz" }
...
local group_definitions = {
    ...
    { name = "kamienie", filter = create_regexp_filter(stones, true) },
