function scripts.ui:setup_footer_info()
    ...
    scripts.ui.column_count = 4
    scripts.ui.info_columns = {}

    for i=1,4 do
        scripts.ui.info_columns[i] = scripts.ui:setup_info_column(i)
    end
...
function scripts.ui:add_element_to_column(index, element)
    scripts.ui.info_columns[index]:add(element)
end
...
function scripts.ui:setup_footer_info_core4()
    ...
    for i = 1, 3 do
        scripts.ui.col4_placeholders[i] = Geyser.Label:new({
            name = "scripts.ui.col4_placeholder_" .. i,
            fontSize = scripts.ui.footer_font_size,
        }, scripts.ui.info_columns[4])
        scripts.ui.col4_placeholders[i]:setStyleSheet(scripts.ui.footer_info_core_base_css:getCSS())
    end
end
