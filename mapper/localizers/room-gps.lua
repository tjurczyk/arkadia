function trigger_func_mapper_localizers_room_gps_ruiny_rinde_za_krata()
...
function trigger_func_mapper_localizers_room_gps_karczma_gnijaca_meduza_ard()
    amap:print_log("GPS po nazwie/wyjsciach lokacji: Karczma 'Gnijaca Meduza'", true)
    amap:set_position(10422, true)
end

function trigger_func_mapper_localizers_room_gps_gora_karczmy_gnijaca_meduza_ard()
    amap:print_log("GPS po nazwie/wyjsciach lokacji: Gora Karczmy 'Gnijaca Meduza'", true)
    amap:set_position(10423, true)
end

function trigger_func_mapper_localizers_room_gps_gryf_zrzucenie()
    amap:set_position(22511, true)
end

function trigger_func_mapper_localizers_room_gps_mario()
